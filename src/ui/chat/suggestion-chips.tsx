    ...
    <div className="flex flex-wrap gap-2 px-4 py-3 justify-center">
      {chips.map((chip) => (
        <button
          ...
          className="flex items-center gap-1.5 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-sm text-gray-300 hover:text-white transition-all cursor-pointer"
        >
